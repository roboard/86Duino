...
// Select platform automatically, if possible
 ...
 #else
  #define RH_PLATFROM RH_PLATFORM_86DUINO
 #endif
#endif
...
#define ATOMIC_BLOCK_START io_DisableINT()
#define ATOMIC_BLOCK_END io_RestoreINT()
...
// See http://arduino.cc/en/Reference/attachInterrupt
 ...
 #define NOT_AN_INTERRUPT -1
  ...
  #define digitalPinToInterrupt(p) ((p) == 42 ? 0 : ((p) == 43 ? 1 : ((p) == 44 ? 2 : NOT_AN_INTERRUPT)))
#endif
