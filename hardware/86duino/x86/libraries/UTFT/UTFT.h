...
*/
	    ...
	    void port_output_value(int port, unsigned char vlaue);
	    void virtual_port_output_value(int port, unsigned char vlaue);
		void port_output_cport(int port, unsigned char vlaue);
	    void port_output_sport(int port, unsigned char vlaue);
	    void port_output_dir(int port, unsigned char vlaue);
