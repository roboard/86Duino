...
UTFT myGLCD(ITDB43,16,17,18,19);   // Remember to change the model parameter to suit your display module!

// Uncomment the next line for 86Duino Zero
//UTFT myGLCD(ITDB43,8,9,10,11);   // Remember to change the model parameter to suit your display module!
