...
// select one Hardware Serial whitch you want to use for Bluetooth module on 86Duino
// and then don't forget to set it's baudrate in setup(), ex: 9600, 38400, 115200 ...
#define BlueTooth_Serial         Serial1
#define BlueTooth_Serial_Baud    9600
...
void setup()
{
  ...
  Firmata.beginBlueTooth(BlueTooth_Serial, BlueTooth_Serial_Baud);
