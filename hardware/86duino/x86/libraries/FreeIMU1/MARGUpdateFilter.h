...
void FreeIMU1::MARGUpdateFilter(double w_x, double w_y, double w_z, double a_x, double a_y, double a_z, double m_x, double m_y, double m_z)
{
    ...
    if ((m_x == 0.0f) && (m_y == 0.0f) && (m_z == 0.0f)) {
        MARGUpdateFilterIMU(w_x, w_y, w_z, a_x, a_y, a_z);
        return;
    }
...
void FreeIMU1::MARGUpdateFilterIMU(double w_x, double w_y, double w_z, double a_x, double a_y, double a_z)
{
	// Local system variables
	double norm; // vector norm
