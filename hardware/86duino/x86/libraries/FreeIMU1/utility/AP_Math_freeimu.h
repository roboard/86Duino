...
//double                   longitude_scale(const struct Location &loc);

// return distance in meters between two locations
//double                   get_distance(const struct Location &loc1, const struct Location &loc2);
...
//void        location_update(struct Location &loc, double bearing, double distance);

// extrapolate latitude/longitude given distances north and east
//void        location_offset(struct Location &loc, double ofs_north, double ofs_east);
...
//double wrap_360_cd_double(double angle);
//double wrap_180_cd_double(double angle);
...
// degrees -> radians
double radians1(double deg);

// radians -> degrees
double degrees1(double rad);
