...
#define GLCD_tDDR   0//320    /* Data Delay time (E high to valid read data)        */
#define GLCD_tAS    0//140    /* Address setup time (ctrl line changes to E HIGH   */
#define GLCD_tDSW   0//200    /* Data setup time (data lines setup to dropping E)   */
#define GLCD_tWH    0//450    /* E hi level width (minimum E hi pulse width)        */
#define GLCD_tWL    0//450    /* E lo level width (minimum E lo pulse width)        */
...
#include "config/ks0108m.h"      // config for mega 1280/2560 board
#elif defined(__AVR_ATmega644P__)  || defined(__AVR_ATmega644__)           
#include "config/ks0108s.h"  // config for Sanguino or other ATmega644/p board
#elif defined(__AVR_AT90USB646__) || defined(__AVR_AT90USB1286__) || defined(__AVR_ATmega32U4__)// Teensy
#include "config/ks0108t.h"    // config for Teensy and Teensy++  
#else
*/
#include "config/ks0108A.h"   // config file for standard Arduino using documented wiring 
//#endif

#include "device/ks0108D.h"
