...
public abstract class Uploader implements MessageConsumer  {
  ...
  public abstract boolean burn86Bootloader() throws RunnerException, SerialException;
  ...
  public void message(String s) {
    ...
    //86duino upload error message
    if (s.indexOf("Write file fail, please check COM port status") != -1) {
      exception = new RunnerException(_("Error uploading."));
      return;
    }
    if (s.indexOf("bootloader no response!!") != -1) {
      exception = new RunnerException(_("Error uploading."));
      return;
    }
    /*if (s.indexOf("Uploading a F/W to flash, please wait..fail, bootloader no response!!") != -1) {
      exception = new RunnerException(_("ERROR uploading.));
      return;
    }*/
  }
